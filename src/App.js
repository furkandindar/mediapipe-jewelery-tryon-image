  ...
  return (
    ...
    <Grid container direction="column">
      <Grid item container direction="row" xs={12} sm={12} md={12} lg={12} xl={12}>
        ...
        <Grid item xs={12} sm={8} md={6} lg={6} xl={4}><img ref={imgRef} src="https://thumbs.dreamstime.com/b/back-side-woman-hand-showing-five-count-36194782.jpg" alt="hand"/></Grid>
